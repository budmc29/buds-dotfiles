...
#Misc aliases
alias zsh="vim ~/.zshrc"
alias dotbackup="cp ~/.hgrc ~/ubuntu-dotfiles/ && cp ~/.tmux.conf ~/ubuntu-dotfiles/ && cp ~/.vimrc ~/ubuntu-dotfiles/ && cp ~/.zshrc ~/ubuntu-dotfiles/ && cd ~/ubuntu-dotfiles && git add -A && git commit -m \"backup\" && git push"
